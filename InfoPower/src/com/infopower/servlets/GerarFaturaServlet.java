...
public class GerarFaturaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Fatura fatura;
			if(acao != null && acao.equals(request.getParameter("acao"))){
				...
				fatura = new Fatura(id, data, consumoRs, consumoDia, consumoMes);
	...
	public void geraPdf(Fatura fatura) {
        ...
        try {
    		...
    		String jrxml = getServletContext().getRealPath("/relatorio") + "/report1.jrxml ";
            ...
            // preenche relatorio
    		JasperPrint jp = JasperFillManager.fillReport(getServletContext().getRealPath("/relatorio") + "/report1.jasper", parametros,jed);
